...
# from mask2former.flatten import TracingAdapter
...
def build_phenobench_test_loader(cfg):
    """
    Returns:
        iterable
...
def get_sample_inputs(args):
    ...
    if args.sample_image is None:
        ...
        data_loader = build_phenobench_test_loader(cfg)
